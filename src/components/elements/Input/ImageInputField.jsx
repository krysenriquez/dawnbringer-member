...
export default function ImageInputField(props) {
  ...
  const {label, required, errorText, name, className, ...rest} = props
  ...
  const blankImage = toAbsoluteUrl(
    ...
    <>
      ...
      >
        <div
          ...
          style={{backgroundImage: `url(${thumbnail})`, backgroundPosition: `center`}}
        />
        <label
